...
import { AppBar, Toolbar, Box, IconButton, Stack, Typography, Tooltip, Menu as MuiMenu, MenuItem, Theme, SxProps } from "@mui/material";
import { Menu, Help, Logout, MoreVert } from "@mui/icons-material";
        ...
        >
            <Toolbar sx={styles.toolbar}>
                ...
                >
                    ...
                    <Stack direction="row" alignItems="center" gap={{ xs: 1, md: 2 }} sx={{ opacity: headerController.dashboardContext.mobileOpen ? 0.8 : 1 }}>
                        ...
                        {!headerController.dashboardContext.mobileOpen && <Stack sx={{ position: 'relative', top: 3, left: 0 }}>
                    ...
                    {!headerController.dashboardContext.mobileOpen && (
                        <>
                            ...
                            <Tooltip title="Logout">
                                <IconButton onClick={headerController.handleLogout}>
                    ...
                    {headerController.dashboardContext.mobileOpen && (
                        <>
                            <Tooltip title="Opciones">
                                <IconButton onClick={headerController.handleOpenOptions}>
                                    <MoreVert sx={{ color: 'white' }} />
                                </IconButton>
                            </Tooltip>
                            <MuiMenu
                                anchorEl={headerController.optionsAnchorEl}
                                open={headerController.isOptionsOpen}
                                onClose={headerController.handleCloseOptions}
                                anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
                                transformOrigin={{ vertical: 'top', horizontal: 'right' }}
                            >
                                <MenuItem component={Link} href="/docs" onClick={headerController.handleCloseOptions}>
                                    Ayuda
                                </MenuItem>
                                <MenuItem onClick={headerController.handleCloseOptions}>
                                    Perfil
                                </MenuItem>
                                <MenuItem
                                    onClick={() => {
                                        headerController.handleCloseOptions();
                                        headerController.handleLogout();
                                    }}
                                >
                                    Cerrar sesión
                                </MenuItem>
